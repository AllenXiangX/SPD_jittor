...
def chamfer_unidirectional_l2(pc1, pc2):
    return chamfer_loss(pc1, pc2, reduction=None, sqrt=False)


def chamfer_loss_bidirectional_batch(pc1, pc2):
    '''
    return the chamfer loss between two point clouds.
    '''
    return chamfer_loss(pc1, pc2, sqrt=False, reduction=None), \
           chamfer_loss(pc2, pc1, sqrt=False, reduction=None)
