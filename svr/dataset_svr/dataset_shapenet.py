...
class ShapeNet(Dataset):
    ...
    def preprocess(self):
        if exists(self.path_dataset + "info.pkl"):
            ...
            self.data_points = jt.load(self.path_dataset + "points.pkl")
        else:
            ...
            self.data_points = concat(self.data_points, 0)
            ...
            jt.save(self.data_points, self.path_dataset + "points.pkl")
    ...
    def _getitem(self, index):
        ...
        norm_points = self.normalization_function(points[:, :3])[0]
        points[:, :3] = norm_points
    ...
    def __getitem__(self, index):
        ...
        return return_dict # return_dict['image'], return_dict['points']
        # return return_dict
